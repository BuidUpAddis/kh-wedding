...
const revealInvitation = () => {
  ...
  ribbonButton.setAttribute("aria-expanded", "true");
  ribbonButton.setAttribute("aria-label", "Invitation revealed");
...
ribbonButton.addEventListener("click", revealInvitation);
